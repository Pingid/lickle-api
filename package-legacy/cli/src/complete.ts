import { choice, cmd, field, isNamespace, shapeOf, string, walk } from '@lickle/legacy-api'
import type { Command, Configured, Namespace, Operation } from '@lickle/legacy-api'
import { isBoolFlag } from './kind.ts'
import { cli, positionalsOf } from './meta.ts'
import { FORMATS } from './output.ts'
import type { InputField } from '@lickle/legacy-api'
