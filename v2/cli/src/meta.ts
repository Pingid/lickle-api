import type { AnyOperation, Schema, Tp, Type, Op } from '@lickle/api-v2'
import type { TypeMeta as _TypeMeta } from '@lickle/api-v2/meta'
...
declare module '@lickle/api-v2/meta' {
