import { choice, cmd, field, isNamespace, shapeOf, string, walk } from '@lickle/api-legacy'
import type { Command, Configured, Namespace, Operation } from '@lickle/api-legacy'
import { isBoolFlag } from './kind.ts'
import { cli, positionalsOf } from './meta.ts'
import { FORMATS } from './output.ts'
import type { InputField } from '@lickle/api-legacy'
